...
export default function LoginEducator(){   // ✅ Changed name here
    ...
    useEffect(() => {
        if(isAuthenticatedSeller){
            navigate('/managecourse')   // backend same → keep as seller
        }
    ...
    return (
        <Fragment>
            <MetaData title={`Login Educator`} /> {/* ✅ Changed title */}
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
                            <div className="mb-8 text-center">
                                <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-800 to-brown-800 mb-4">
                                    Welcome back Educator! {/* ✅ Changed text */}
                                </h1>
                            ...
                            <form onSubmit={submitHandler} className="space-y-6">
                                ...
                                <div className="flex items-center">
                                    <Link 
                                        to="/password/forgotSeller"   // backend same
                                ...
                                <div className="text-center mt-6">
                                    ...
                                    <Link 
                                        to="/registerSeller"   // backend same
