            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 p-10 flex flex-col">
                    ...
                    <form onSubmit={submitHandler} className="space-y-6" encType="multipart/form-data">
                        ...
                        {/* Avatar Upload Field */}
                        <div className="bg-amber-50/50 rounded-2xl p-6 mb-4 border border-amber-100">
                            <label htmlFor="avatar_upload" className="text-lg font-semibold text-brown-800 flex items-center mb-2">
                                <svg className="w-5 h-5 mr-2 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <label
                                        htmlFor="customFile"
                                        className="w-full px-4 py-2 bg-gradient-to-r from-amber-600 to-brown-600 text-white rounded-xl text-center block hover:shadow-lg hover:from-amber-700 hover:to-brown-700 transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer"
                                    >
                                        Choose Avatar
                                    </label>
                                </div>
